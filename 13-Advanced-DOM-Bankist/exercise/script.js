...
//  Determine the waht element originated the element
...
const stickyNav = function (entries) {
  const [entry] = entries;
  // console.log(entry);
  if (!entry.isInterscting) nav.classList.add('sticky');
  else nav.classList.remove('sticky');
};
